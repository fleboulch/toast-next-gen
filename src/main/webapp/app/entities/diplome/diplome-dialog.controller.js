(function() {
    ...
    DiplomeDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Diplome', 'Filiere', 'Partenariat', 'Etudiant', 'Intervenant'];

    function DiplomeDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Diplome, Filiere, Partenariat, Etudiant, Intervenant) {
        var vm = this;
