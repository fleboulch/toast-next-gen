(function() {
    ...
    DiplomeDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Diplome', 'Filiere', 'EntreprisePartenaire', 'Etudiant'];

    function DiplomeDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Diplome, Filiere, EntreprisePartenaire, Etudiant) {
        var vm = this;
