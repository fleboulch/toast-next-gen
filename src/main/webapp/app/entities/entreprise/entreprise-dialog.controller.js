(function() {
    ...
    EntrepriseDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Entreprise', 'Partenariat', 'Site', 'Intervenant', 'Groupe'];

    function EntrepriseDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Entreprise, Partenariat, Site, Intervenant, Groupe) {
        var vm = this;
        ...
        vm.sites = Site.query();
        vm.intervenants = Intervenant.query();
