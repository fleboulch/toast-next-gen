...
public class PartenariatResource {
    ...
    @Timed
    public List<PartenariatDTO> getAllPartenariats() {
        log.debug("REST request to get all Partenariats");
        return partenariatService.findAll();
    }
    ...
    @Timed
    public List<PartenariatDTO> searchPartenariats(@RequestParam String query) {
        log.debug("REST request to search Partenariats for query {}", query);
        return partenariatService.search(query);
    }
