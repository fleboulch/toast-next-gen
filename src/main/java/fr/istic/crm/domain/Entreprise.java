...
public class Entreprise implements Serializable {
    ...
    public Entreprise entreprisePartenaires(Set<EntreprisePartenaire> entreprisePartenaires) {
        this.entreprisePartenaires = entreprisePartenaires;
        return this;
    }

    public Entreprise addEntreprisePartenaire(EntreprisePartenaire entreprisePartenaire) {
        entreprisePartenaires.add(entreprisePartenaire);
        entreprisePartenaire.setEntreprise(this);
        return this;
    }

    public Entreprise removeEntreprisePartenaire(EntreprisePartenaire entreprisePartenaire) {
        entreprisePartenaires.remove(entreprisePartenaire);
        entreprisePartenaire.setEntreprise(null);
        return this;
    }
