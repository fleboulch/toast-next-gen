...
public class SiteResourceIntTest {
    ...
    private static final Boolean DEFAULT_SIEGE = false;
    private static final Boolean UPDATED_SIEGE = true;
    ...
    public void createSite() throws Exception {
        ...
        assertThat(testSite.isSiege()).isEqualTo(DEFAULT_SIEGE);
    ...
    public void getAllSites() throws Exception {
        ...
        restSiteMockMvc.perform(get("/api/sites?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].siege").value(hasItem(DEFAULT_SIEGE.booleanValue())))
    ...
    public void getSite() throws Exception {
        ...
        restSiteMockMvc.perform(get("/api/sites/{id}", site.getId()))
            ...
            .andExpect(jsonPath("$.siege").value(DEFAULT_SIEGE.booleanValue()))
    ...
    public void updateSite() throws Exception {
        ...
        assertThat(testSite.isSiege()).isEqualTo(UPDATED_SIEGE);
