...
public class TuteurResourceIntTest {
    ...
    public void createTuteur() throws Exception {
        ...
        assertThat(testTuteur.getFonction()).isEqualTo(DEFAULT_FONCTION);
        assertThat(testTuteur.isAncienEtudiant()).isEqualTo(DEFAULT_ANCIEN_ETUDIANT);
        assertThat(testTuteur.getDebutVersion()).isEqualTo(DEFAULT_DEBUT_VERSION);
        assertThat(testTuteur.getFinVersion()).isEqualTo(DEFAULT_FIN_VERSION);
    ...
    public void updateTuteur() throws Exception {
        ...
        assertThat(testTuteur.getFonction()).isEqualTo(UPDATED_FONCTION);
        assertThat(testTuteur.isAncienEtudiant()).isEqualTo(UPDATED_ANCIEN_ETUDIANT);
        assertThat(testTuteur.getDebutVersion()).isEqualTo(UPDATED_DEBUT_VERSION);
        assertThat(testTuteur.getFinVersion()).isEqualTo(UPDATED_FIN_VERSION);
