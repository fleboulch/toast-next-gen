...
public class ConventionStageResourceIntTest {
    ...
    private static final Long DEFAULT_DATE_DEBUT = 1L;
    private static final Long UPDATED_DATE_DEBUT = 2L;

    private static final Long DEFAULT_DATE_FIN = 1L;
    private static final Long UPDATED_DATE_FIN = 2L;
    ...
    public void getAllConventionStages() throws Exception {
        ...
        restConventionStageMockMvc.perform(get("/api/convention-stages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateDebut").value(hasItem(DEFAULT_DATE_DEBUT.intValue())))
            .andExpect(jsonPath("$.[*].dateFin").value(hasItem(DEFAULT_DATE_FIN.intValue())));
    }
    ...
    public void getConventionStage() throws Exception {
        ...
        restConventionStageMockMvc.perform(get("/api/convention-stages/{id}", conventionStage.getId()))
            ...
            .andExpect(jsonPath("$.dateDebut").value(DEFAULT_DATE_DEBUT.intValue()))
            .andExpect(jsonPath("$.dateFin").value(DEFAULT_DATE_FIN.intValue()));
    }
